...
{
    public class TrayAppEnhanced : ApplicationContext
    {
        ...
        public TrayAppEnhanced()
        {
            try
            {
                LogDebug("TrayAppEnhanced starting...");
                ...
                LogDebug("TrayAppEnhanced initialization complete");
            }
            catch (Exception ex)
            {
